...
package xyz.opcal.demo.cloud.sc.shop.controller;
...
class SCShopDubboControllerTest {
	...
	void submit() {
		...
		var response = restTemplate.postForEntity("/dubbo/submit", new HttpEntity<>(params), String.class);
