...
import xyz.opcal.demo.cloud.sc.shop.service.ShopDubboService;

@Slf4j
@Service
public class ShopDubboServiceImpl implements ShopDubboService {

	@DubboReference(providedBy = "account-service-dubbo")
	private AccountApiService accountApiService;

	@DubboReference(providedBy = "account-storage-dubbo")
